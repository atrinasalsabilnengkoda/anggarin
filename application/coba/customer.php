...
class customer extends CI_Controller {
    ...
    public function histori($id_customer){
        ...
        $data['customer']=$this->customer_model->getCustomerByID($id_customer);
        $data['data_customer']=$this->customer_model->getCustomer($id_customer);
    ...
    public function status($id_customer){
        $data['statusCustomer']=$this->customer_model->getStatusCustomer($id_customer);
        $this->load->view('template/header', $data);
        $this->load->view('customer/index');
        $this->load->view('template/footer');
    }
