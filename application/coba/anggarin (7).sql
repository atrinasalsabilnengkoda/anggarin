...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 25, 2021 at 12:18 PM
...
(4, 'Paijo', '3456786', 'BNI', 'Jl Call Me Baby 1234', '0813349102', 1000000, 'Aktif', 'Akun Bank'),
...
(1, 'Vira Meliana', 'vira@gmail.com', '082255790865', 'Lunas', '2021-06-17'),
...
(10, 'Naeyeon', 'naeyeon@gmail.com', '08134574804', 'Lunas', '2021-08-25');
...
INSERT INTO `orders` (`id_order`, `id_customer`, `id_produk`, `tanggal_order`, `jumlah_order`, `total_order`, `status_order`) VALUES
(1, 1, 2, '2021-01-07', 2, 0, 'Proses'),
(2, 2, 2, '2021-07-20', 1, 0, 'Selesai'),
(3, 5, 3, '2021-01-02', 3, 0, 'Selesai'),
(4, 3, 4, '2021-02-02', 1, 0, 'Selesai'),
(5, 4, 5, '2021-06-04', 1, 0, 'Selesai'),
(6, 1, 1, '2021-01-13', 2, 0, 'Selesai'),
(7, 8, 4, '2021-08-24', 1, 0, 'Selesai'),
(8, 8, 5, '2021-08-24', 3, 0, 'Proses'),
(9, 9, 5, '2021-08-24', 1, 0, 'Selesai'),
(10, 10, 6, '2021-08-25', 1, 0, 'Proses');
...
(6, 6, 'Bitdefender 2019', '2021-08-24', 600000, 'Transfer', 'Atrina Salsabil', 'Lunas');
...
(2, 'Zubaedah', 'Camtasia', 'Camtasia 2018', 200000, 240000, 4, 'Camtasia merupakan software blablabla', 'akan habis', 'Maemunah.jpg'),
...
(5, 'Gabriel', 'Filmora', 'Filmora 2010', 250000, 300000, 5, 'jhjklklklk', '', 'Maemunah.jpg'),
(6, 'Wisam', 'Adobe', 'AutoCAD 2012', 250000, 300000, 2, 'asfafaf', '', 'Maemunah.jpg');
...
(1, 'Maemunah', '08734562123', 'maemunah@gmail.com', 'Adobe', 'Belum Lunas', NULL),
(2, 'Zubaedah', '08245996755', 'zubaedah@gmail.com', 'Adobe', 'Lunas', NULL),
(3, 'Chrisabel Olivia', '08124384744', 'ibel@gmail.com', 'Adobe', 'Lunas', 'default.jpg'),
(4, 'Louis', '081244743932', 'louis@gmail.com', 'Microsoft Office', 'Lunas', 'default.jpg'),
(5, 'Gabriel', '081244743932', 'gabriel@gmail.com', 'Filmora', 'Lunas', 'default.jpg'),
(6, 'Wisam', '081244743932', 'wisam@gmail.com', 'Adobe', 'Lunas', NULL);
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `FK_CustOrder` FOREIGN KEY (`id_customer`) REFERENCES `customer` (`id_customer`),
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`id_produk`) REFERENCES `produk` (`id_produk`);
COMMIT;
