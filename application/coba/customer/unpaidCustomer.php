                    ...
                    <div class="card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-tabs-custom mb-4">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link p-3 fw-bold" data-toggle="tab" href="<?php echo base_url('')?>paidCustomer">Paid</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link p-3 fw-bold active" data-toggle="tab" href="<?php echo base_url('')?>unpaidCustomer">Unpaid</a>
                                </li>
                            </ul>
                            <div class="table mt-3 tab-content">                               
                                <table id="datatable-buttons" class="table table-centered datatable dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <?php foreach($unpaid_customer as $customer): ?>
                                            <tr>
                                                <td></td>
