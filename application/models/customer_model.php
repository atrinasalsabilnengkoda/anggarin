...
class customer_model extends CI_Model{
    ...
    public function getHistoriCustomer($id_customer){
        $sql = "SELECT o.tanggal_order, p.nama_produk, o.jumlah_order, (p.harga_jual * jumlah_order) as total_order, o.status_order FROM orders AS o JOIN customer AS c ON o.id_customer = c.id_customer JOIN produk AS p ON p.id_produk = o.id_produk WHERE o.id_customer = $id_customer";
        $result = $this->db->query($sql);
        return $result->result_array();
    }
}
