                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs nav-tabs-custom mb-4">
                                    <li class="nav-item">
                                        <a class="nav-link fw-bold p-3 " href="<?php echo base_url('')?>payment">All Payments</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link p-3 fw-bold " href="<?php echo base_url('')?>paidPayment">Paid</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link p-3 fw-bold active" href="<?php echo base_url('')?>unpaidPayment">Unpaid</a>
                                    </li>
                                </ul>
                                <div class="table mt-3 tab-content">
                                    <table class="table table-centered datatable dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php $no=1;
                                            foreach($unpaid_pembayaran as $pembayaran): ?>
                                            <tr>
                                                <td></td>
                                                <td><?= $no++?></td>
                                                <td><?= $pembayaran['tanggal_pembayaran'];?></td>
                                                <td><?= $pembayaran['nama_supplier'];?></td>
                                                <td><?= $pembayaran['telp_supplier'];?></td>
