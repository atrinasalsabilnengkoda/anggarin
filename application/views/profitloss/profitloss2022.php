                                ...
                                <div class="table-rep-plugin">
                                    ...
                                    <table id="tech-companies-1" class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>Pendapatan</th>
                                                <th>Rp. <?php echo $pendapatan_janapr2022; ?></th>
                                                <th>Rp. <?php echo $pendapatan_meiaug2022; ?></th>
                                                <th>Rp. <?php echo $pendapatan_sepdes2022; ?></th>
                                                <th>Rp. <?php echo $pendapatan_janapr2022+$pendapatan_meiaug2022+$pendapatan_sepdes2022; ?></th>
                                            </tr>
                                            <tr>
                                                <th><p><strong>Laba Kotor</strong></p></th>  
                                                <th>Rp. <?php echo $labakotor_pendapatan2022 = $pendapatan_janapr2022+$pendapatan_meiaug2022+$pendapatan_sepdes2022; ?></th>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    <tr>
                                        <th>Tagihan</th>
                                        <th>Rp. <?php echo $pengeluaran_janapr2022; ?></th>
                                        <th>Rp. <?php echo $pengeluaran_meiaug2022; ?></th>
                                        <th>Rp. <?php echo $pengeluaran_sepdes2022; ?></th>
                                        <th>Rp. <?php echo $pengeluaran_janapr2022+$pengeluaran_meiaug2022+$pengeluaran_sepdes2022; ?></th>
                                    </tr>
                                    <tr>
                                        <th><p><strong>Laba Kotor</strong></p></th>
                                        <th>Rp. <?php echo $labakotor_pengeluaran2022 = $pengeluaran_janapr2022+$pengeluaran_meiaug2022+$pengeluaran_sepdes2022; ?></th>
                                    </tr>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    <tr>
                                        <th>Laba Bersih</th>
                                        <th>Rp. <?php echo $labakotor_pendapatan2022-$labakotor_pengeluaran2022; ?></th>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
