                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs nav-tabs-custom mb-4">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link p-3 fw-bold " href="<?php echo base_url('')?>paidSupplier">Paid</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link p-3 fw-bold active" href="<?php echo base_url('')?>unpaidSupplier">Unpaid</a>
                                </li>
                            </ul>
                            <div class="table mt-3 tab-content">
                                    <table id="datatable-buttons" class="table table-centered datatable dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php $no=1;
                                            foreach($unpaid_supplier as $supplier): ?>
                                            <tr>
                                                <td></td>
                                                <td><?= $no++?></td>
