                        ...
                        <div class="page-title">
                            <h4>Report</h4>
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Laporan Pendapatan Tahun 2020</li>
                                </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="float-sm-right">
                                    <h3 class="header-title">Grafik Pendapatan Tahun 2020</h3>
                                </div><br>
                                <div class="row align-items-center">
                                    <div class="col-xl-9">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Rp. <?php echo $pendapatan_jan2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_feb2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_mar2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_apr2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_mei2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_jun2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_jul2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_agu2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_sep2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_okt2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_nov2020; ?></td>
                                            <td>Rp. <?php echo $pendapatan_des2020; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
