                        ...
                        <div class="page-title">
                            <h4>Report</h4>
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Laporan Pendapatan All Years</li>
                                </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="float-sm-right">
                                    <h3 class="header-title">Grafik Pendapatan All Years</h3>
                                </div><br>
                                <div class="row align-items-center">
                                    <div class="col-xl-9">
                    ...
                    <div class="col-12">
                        <div class="btn-group mt-1 me-1">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="<?php echo base_url('')?>income2021">2021</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Rp. <?php echo $pendapatan_janAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_febAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_marAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_aprAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_meiAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_junAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_julAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_aguAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_sepAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_oktAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_novAllYears; ?></td>
                                            <td>Rp. <?php echo $pendapatan_desAllYears; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
