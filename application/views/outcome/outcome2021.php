                        ...
                        <div class="page-title">
                            <h4>Report</h4>
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Laporan Pengeluaran Tahun 2021</li>
                                </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="float-sm-right">
                                    <h3 class="header-title">Grafik Pengeluaran Tahun 2021</h3>
                                </div><br>
                                <div class="row align-items-center">
                                    <div class="col-xl-9">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Rp. <?php echo $pengeluaran_jan2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_feb2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_mar2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_apr2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_mei2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_jun2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_jul2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_agu2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_sep2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_okt2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_nov2021; ?></td>
                                            <td>Rp. <?php echo $pengeluaran_des2021; ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
