                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <ul class="nav nav-tabs nav-tabs-custom mb-4">
                                                <li class="nav-item">
                                                    <a class="nav-link fw-bold p-3 " href="<?php echo base_url('')?>bank">All Bank Accounts</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link p-3 fw-bold" href="<?php echo base_url('')?>bankActive">Active</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link p-3 fw-bold active" href="<?php echo base_url('')?>bankUnactive">Unactive</a>
                                                </li>
                                            </ul>
